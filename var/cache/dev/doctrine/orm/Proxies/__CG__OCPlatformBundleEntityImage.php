...
class Image extends \OC\PlatformBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'imageFile', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'imageSize', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'imageName', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'updatedAt'];
        }
